...
function main() {
    var messages = [
        ...
        "Ce site peut régulièrement diffuser des informations orientées (à gauche ou à droite), imprécise voir sans véritable sources. Il est également possible que certains journalistes s'auto-censurent, soient soumis ou de mauvaise foi, ou souffrent de légers biais de confirmation (ce qui n'est pas grave, cela nous arrive à tous.",
